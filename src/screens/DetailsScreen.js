        ...
        <View style={styles.clubTab}>
          ...
          >
            <Text
              ...
              size={15}
              style={[
                this.state.activeIndex == 0 ? {} : { color: colors.lightGrey }
              ]}
            >
              Home
            </Text>
          ...
          >
            <Text
              ...
              size={15}
              style={[
                this.state.activeIndex == 1 ? {} : { color: colors.lightGrey }
              ]}
            >
              Schedule
            </Text>
          ...
          >
            <Text
              ...
              size={15}
              style={[
                this.state.activeIndex == 2 ? {} : { color: colors.lightGrey }
              ]}
            >
              Players
            </Text>
          ...
          >
            <Text
              ...
              size={15}
              style={[
                this.state.activeIndex == 3 ? {} : { color: colors.lightGrey }
              ]}
            >
              Setting
            </Text>
